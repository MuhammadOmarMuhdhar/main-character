...
class JetstreamCollector:
    ...
    def on_message(self, ws, message):
        ...
        # print(f"DEBUG: Received message: {message[:200]}...")  # First 200 chars
        try:
    ...
    def on_error(self, ws, error):
        ...
        # print(f"DEBUG: WebSocket error type: {type(error)}")
        # print(f"DEBUG: WebSocket error details: {error}")
        import traceback
        traceback.print_exc()
    ...
    def on_close(self, ws, close_status_code, close_msg):
        ...
        print(f"DEBUG: Close status type: {type(close_status_code)}")
        if close_status_code:
            print(f"DEBUG: Standard close codes - 1000=normal, 1001=going away, 1002=protocol error, 1003=unsupported data")
        self.connected = False
